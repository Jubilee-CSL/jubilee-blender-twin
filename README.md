...
> **Screenshot needed:** Full Blender window with the N-panel open on the Twin tab, showing Setup, Animation, and Ray Tracing subpanels.

### Setup subpanel

> **Screenshot needed:** Setup subpanel with both buttons visible.
...
> **Screenshot needed:** Scene after "Place Tools" — tools and parking posts visible on the Jubilee frame.
...
> **Screenshot needed:** Scene after "Populate Deck" — labware sitting on the deck plate.

### Animation subpanel

> **Screenshot needed:** Animation subpanel showing the GCode dropdown listing experiment files from gcode_logs/.
...
> **Screenshot needed:** Blender timeline after animation — keyframes visible on X-axis, Y-axis, Z-axis.

### Ray Tracing subpanel

Click **Launch Ray Tracing** to run collision detection on the current animation.

> **Screenshot needed:** Ray Tracing subpanel with a collision list populated, and red objects visible in the viewport.
...
> **Screenshot needed:** Interface app with labware placed on the deck and Export 3D button visible.
> **Screenshot needed:** `experiment_deck/<date>_experience/` folder in Explorer showing deck.blend alongside deck.json and STL files.
